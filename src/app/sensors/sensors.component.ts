...
export class SensorsComponent implements OnInit  {
  ...
  ngOnInit() {
    ...
    this.servors = [
      ...
      {sensor_id:12, sensor_name_tx:"Curtain 2 status T1", sensor_value_tx:"Disconnected", serialnum_tx:"2416", mod_dt:"2017-05-13 17:41:48", class:"mat-red-600", icon: "whatshot"},
      ...
      {sensor_id:74, sensor_name_tx:"Precipitation", sensor_value_tx:"No rain", serialnum_tx:"3491", mod_dt:"2017-05-13 10:41:36", class:"mat-brown", icon: "wb_sunny"},
      {sensor_id:21, sensor_name_tx:"Probe#1", sensor_value_tx:" 55.8", serialnum_tx:"4809", mod_dt:"2017-05-13 7:41:31", class:"mat-blue-800", icon: "notifications_none"},
      ...
      {sensor_id:56, sensor_name_tx:"T14", sensor_value_tx:"Working", serialnum_tx:"9773", mod_dt:"2017-05-13 10:41:38", class:"mat-green", icon: "not_interested"},
